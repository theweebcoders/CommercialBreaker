...
class Page5(ttk.Frame):
    def __init__(self, parent, controller, logic):
        ...
        self.TOM_logic.subscribe_to_updates('filtered_files', self.load_filtered_files_handler)
        self.TOM_logic.subscribe_to_updates('cutless_state', self.handle_cutless_state_update)
